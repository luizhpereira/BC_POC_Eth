...
w = weight
ci = loadcell identifier in order to terminal
r = raw data of the loadcell
t = temperature
p = power supply of the loadcell
v = internal voltage of the loadcell
sn = serial number of the loadcell
sv = loadcell's version
